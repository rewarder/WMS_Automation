...
def process_dxf(input_file, output_file, log_file_path):
    ...
    # Step 11: List hatch boundary points
    try:
    ...
    # Step 14: Copy all Line, Cirle and Arc entities into an empty new drawing
    try: 
        # Call the rename layers function
        copy_entities_into_new_drawing(doc) # Rename layers according to WMS naming convention
