    ...
    for solid in msp.query('SOLID'):
        ...
        if vertices:
            ...
            for i in range(len(vertices)):
                ...
                # Create a line and carry over attributes from the solid
                line = msp.add_line(start_point, end_point)
                line.dxf.layer = solid.dxf.layer
                line.dxf.color = solid.dxf.color
                line.dxf.linetype = solid.dxf.linetype
