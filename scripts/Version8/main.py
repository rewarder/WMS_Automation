...
def process_dxf(input_file, output_file, log_file_path):
    ...
    # Step 5: Extract text, positions, heights, and rotations
    try:
    ...
    # Step 6: Convert text to boundary lines within the same drawing
    try:
    ...
    # Step 9: Convert 2D Polylines to lines
    try:
    ...
    # Step 10: Convert 3D Polylines to lines
    try:
    ...
    # Step 11: Create boundary lines for all hatches
    try:
    ...
    # Step 12: Create boundary lines for all Face3D entities
    try:
    ...
    # Step 14: Delete all entities outside CH boundary box
    try:
    ...
    # Step 15: Delete all leader entities
    try:
    ...
    # Step 16: Delete all Face3D entities
    try:
    ...
    # Step 17: Delete all MPolygon entities
    try:
    ...
    # Step 18: Delete all polyline entities
    try:
    ...
    # Step 19: Delete all hatch entities
    try:
    ...
    # Step 20: Delete all text entities
    try:
    ...
    # Step 21: Delete all MText entities
    try:
    ...
    # Step 22: Delete all point entities
    try:
    ...
    # Step 23: Delete all body entities
    try:
    ...
    # Step 24: Delete all iamge entities
    try:
    ...
    # Step 25: Delete all wipeout entities
    try:
    ...
    # Step 26: Delete all solid entities
    try:
    ...
    # Step 27: Delete all 3Dsolid entities
    try:
    ...
    # Step 29: Cleanup intermediate files
    ...
    # Step 30: It's time to count all entities
    try:
