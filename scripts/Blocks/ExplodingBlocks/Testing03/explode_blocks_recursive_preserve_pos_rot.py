...
def main():
    try:
        doc = ezdxf.readfile("C:/Users/mbuechel/Desktop/ToDo/Automation/DXFAutomation/Scripts/Blocks/ExplodingBlocks/Testing03/input_05.dxf")
    ...
    try:
        doc.saveas("C:/Users/mbuechel/Desktop/ToDo/Automation/DXFAutomation/Scripts/Blocks/ExplodingBlocks/Testing03/output_pos_rot_t03_05.dxf")
        print("Modified DXF file saved as 'output_pos_rot_t02_05.dxf'.")
    except IOError:
