...
def process_dxf(input_file, output_file, log_file_path):
    ...
    try:
        explode_dimensions(current_file, intermediate_files[0])
    ...
    # Step 3: Explode MText
    try:
        explode_mtext(current_file, intermediate_files[1])
    ...
    # Delete all entities outside CH boundary box
    try:
